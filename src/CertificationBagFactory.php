...
class CertificationBagFactory
{
     ...
     * @return CertificationBag
     */
    public static function production($server_certificate = null)
    {
        $env = CertificationBag::PRODUCTION;
        $client_private_key = dirname(__FILE__) . '/certs/webpay-plus-production/597032571484.key';
        $client_certificate = dirname(__FILE__) . '/certs/webpay-plus-production/597032571484.crt';
     ...
     * @return CertificationBag
     */
    public static function productionOneClick($server_certificate = null)
    {
        $env = CertificationBag::PRODUCTION;
        $client_private_key = dirname(__FILE__) . '/certs/webpay-oneclick-production/597032795005.key';
        $client_certificate = dirname(__FILE__) . '/certs/webpay-oneclick-production/597032795005.crt';
        return new CertificationBag($client_private_key, $client_certificate, $server_certificate, $env);
    }
